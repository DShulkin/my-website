      ...
      <div className="icon-container">
        {/* GitHub Icon */}
          <button aria-label="Open GitHub profile"
            onClick={() => window.open("https://github.com/dshulkin", "_blank", "noopener noreferrer")}
          >
            <svg
        ...
        {/* LinkedIn Icon */}
            ...
            onClick={() => window.open("https://www.linkedin.com/in/davidchemrukov", "_blank", "noopener noreferrer")}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
        ...
        {/* Instagram Icon */}
          <button aria-label="Open Instagram profile"
            onClick={() => window.open("https://www.instagram.com/self.illusion/", "_blank", "noopener noreferrer")}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
